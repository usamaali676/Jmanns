...
<style>
    .page_header .page_header_content{
        background-image: url('{{ asset('assets/images/aboutbanner.webp') }}');
    }
</style>
    ...
    <div class="top_feature section">
        <div class="container">
            <div class="full_image_holder">
                <img src="{{asset('assets/images/About-us.webp')}}" alt="">
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    <div class="group_image_holder">
                        ...
                        <img class="main_img" src="{{asset('assets/images/moreabout1.webp')}}" alt="">
                        <img class="sub_img" src="{{asset('assets/images/moreabout2.webp')}}" alt="">
                    </div>
                </div>
